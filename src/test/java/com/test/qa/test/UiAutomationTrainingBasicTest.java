...
public class UiAutomationTrainingBasicTest extends TestBase {
	...
	public void testVerifyHomePage() {
		softAssert = new SoftAssert();//softAssert- verify each method done successfully or not
		softAssert.assertTrue(HomePage.isHomePageDisplayed(), "Home Page is not Displayed");
		HomePage.clickLink(Constants.AB_TEST_LINK); ABTestPage.waitTillHeaderLoad();
